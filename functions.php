...
$custres = mysqli_query($conn,$custsql)or die(mysql_error());;
...
$itemsres = mysqli_query($conn,$itemssql)or die(mysql_error());;
...
$totalres = mysqli_query($conn,$totalsql)or die(mysql_error());;
}
echo "<tr>";
echo "<td></td>";
echo "<td></td>";
